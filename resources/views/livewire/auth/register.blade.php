...
<div class="bg-white p-8 sm:mx-auto sm:w-full sm:max-w-md rounded-lg">
    <div class="fixed overflow-hidden -z-10 inset-0">
        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="register">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="address" id="address" type="text" required
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="birthday" id="birthday" type="date" required
                ...
                <div x-data="{modal: false}">
                    <button type="button" @click="modal = true; console.log(1);"
                        class="text-blue-600 text-sm mt-3 inline-block">Terms
                        and
                        Conditions</button>
                    <div x-show="modal" x-cloak
                        class="fixed z-50 inset-0 grid place-items-center bg-gray-900 bg-opacity-50 p-8">
                        <div class="bg-white overflow-auto max-h-full p-8 w-1/2">
                            <x-terms_and_conditions />
                            <div class="flex justify-end">
                                <button @click="modal = false;" class="btn btn-primary">I agree</button>
                            </div>
                        </div>
                    </div>
                </div>
